...
public class PositionManagerConfig {
    ...
    public PositionManagerConfig(String bootstrapServers, String topic, String groupId, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static PositionManagerConfig fromEnv() {
        ...
        return new PositionManagerConfig(bootstrapServers, topic, groupId, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
