...
public class PositionGeneratorConfig {
    ...
    public PositionGeneratorConfig(String bootstrapServers, String topic, int timer, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static PositionGeneratorConfig fromEnv() {
        ...
        return new PositionGeneratorConfig(bootstrapServers, topic, timer, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
