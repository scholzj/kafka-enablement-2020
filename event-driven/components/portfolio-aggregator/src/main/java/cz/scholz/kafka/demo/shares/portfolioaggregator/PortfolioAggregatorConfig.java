...
public class PortfolioAggregatorConfig {
    ...
    public PortfolioAggregatorConfig(String bootstrapServers, String sourceTopic, String targetTopic, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static PortfolioAggregatorConfig fromEnv() {
        ...
        return new PortfolioAggregatorConfig(bootstrapServers, sourceTopic, targetTopic, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
