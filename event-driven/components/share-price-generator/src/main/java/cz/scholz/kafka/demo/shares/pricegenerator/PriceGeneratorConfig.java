...
public class PriceGeneratorConfig {
    ...
    public PriceGeneratorConfig(String bootstrapServers, String topic, int timer, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static PriceGeneratorConfig fromEnv() {
        ...
        return new PriceGeneratorConfig(bootstrapServers, topic, timer, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
